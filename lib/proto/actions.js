 ...
 *
 *   (the two store badges were removed from the page entirely, so their
 ...
 *   tailing a bet         NOT a missing table. A deliberate omission.
 *                         Tailing exists to make somebody place a bet they
 *                         otherwise would not, and CLAUDE.md locks the line
 *                         that nothing in this product may nudge toward more
 *                         volume — the red/green grid and the rankings are
 *                         already engagement mechanics and that is the
 *                         ceiling. The feed, the profile and following all
 *                         ship; the control that turns somebody else's bet
 *                         into your bet does not. Revisit only after the
 *                         Gambling Commission question in CLAUDE.md has an
 *                         answer, not before.
 *
