...
const unitExample=u=>`<div class="row" style="font-size:12.5px;justify-content:space-between">
  <span>Stake £${u}, returns £${u*2} <span style="color:var(--t3)">so profit is £${u}</span></span><b class="mono" style="color:var(--pos)">+1.00u</b></div>
 <div class="row" style="font-size:12.5px;justify-content:space-between;margin-top:7px">
  <span>Stake £${u*2}, returns £0 <span style="color:var(--t3)">so loss is £${u*2}</span></span><b class="mono" style="color:var(--neg)">−2.00u</b></div>
...
V.manual={narrow:1,nav:'imp',html:()=>`<div class="pane"><h2 style="font-size:22px;margin:0 0 10px">Type it in</h2>
 ...
 <div style="display:flex;gap:9px"><div style="flex:1"><label class="flabel">Stake</label><input class="field mono" placeholder="£25.00" inputmode="decimal" autocomplete="off"></div>
  <div style="flex:1"><label class="flabel">Odds</label><input class="field mono" placeholder="1.90" inputmode="decimal" autocomplete="off"></div></div>
