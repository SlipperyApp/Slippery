...
function film(name, label, caption){
 ...
 <figcaption class="note filmcap">${esc(caption)}</figcaption>
</figure>`;
}
...
<div class="lhero"><div class="inner">
 <div class="herocol">
  ...
  <ul class="herofacts">
   <li>Free for 5 days or 15 slips</li>
   <li>No card to look around</li>
   <li>Export everything, always</li></ul>
  <div class="storeb">${APPLEBADGE}${PLAYBADGE}</div>
  <p class="storenote">Coming soon to iOS and Android. The web app works today.</p>
 </div>
...
<div class="lsec c" data-sec="settle"><h2 class="lh2">Every slip, settled either way.</h2>
 <p class="lsub">Six outcomes, and a rule for each. When it cannot be sure, it asks you.</p>
 ${film('settling','How Slippery settles a bet, twenty six seconds','Twenty six seconds, no sound.')}</div>

<div class="lsec c" data-sec="tour"><h2 class="lh2">See it in action.</h2>
 <p class="lsub">The dashboard, the ledger, the month, and what is still running.</p>
 ${film('in-action','A tour of Slippery, twenty six seconds','Twenty six seconds, no sound.')}</div>
...
<div class="lsec c"><h2 class="lh2">Send a bet on Telegram.<br>It is tracked instantly.</h2>
 ...
 <div class="tgbox">
  ...
  ${film('bot','How the Telegram bot works, twenty seconds','Twenty seconds, no sound.')}</div></div>
 ...
 <div class="tgbox aura">
  <ul class="tgflow">
   ${[['Export from your old tracker','CSV or Excel, however it comes out'],['Drop the file in','No column mapping to learn'],['Every row read and checked','Duplicates flagged, nothing overwritten']].map(x=>`
    <li class="tgstep"><span class="tgn"></span><div><b>${x[0]}</b><span>${x[1]}</span></div></li>`).join('')}</ul>
  ${film('import','How importing your history works, twenty seconds','Twenty seconds, no sound.')}</div></div>
<div class="lsec c newfeat" data-sec="social"><span class="newtag">New</span>
 ...
 ${film('social','How groups and following work, twenty seconds','Twenty seconds, no sound.')}</div>
