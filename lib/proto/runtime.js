...
V.su6={bare:1,html:()=>wiz(6,6,'Choose a plan','Pick one now. You can switch or cancel later.',`
 ...
 ${[['Free trial','£0',TRIAL.ref+', whichever ends sooner (switches to annual subscription after).',0],
    ...
    ['Annual','£29.99 a year','£2.50 a month. Save £11.89 against monthly.',1]].map(x=>`
  <button class="plancell${x[3]?' on':''}" data-pickone aria-current="${x[3]}">
 ...
 <button class="btn full" style="margin-top:12px" data-signin>Continue to payment</button>`)};
