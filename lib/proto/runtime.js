...
/* The wordmark text is hidden below 428px and the mark is kept, which left
   the button with nothing but a path in it and no name at all on the two
   smallest widths. The label is on the button rather than on the svg so it
   holds whether or not the text beside it is drawn. */
