...
V.person={narrow:1,nav:'soc',back:'social',title:'BlueSlip',html:()=>`<div class="pane">
 <div class="card" style="text-align:center"><span class="av" style="width:58px;height:58px;font-size:20px;margin:0 auto 10px">BS</span>
  ...
  <!-- 07 · A "Following" button used to sit here and only raise a toast.
       Removed rather than faked: following is only meaningful once there is
       a feed to follow into, and a control that does nothing reads as a
       broken app. It returns with the feed. --></div>
...
V.bs_failed={nav:'set',back:'settings',title:'Payment declined',html:()=>`<div class="pane">
