...
/** The six that decide whether somebody signs up: what it is, why it works
 *  that way, what it costs and what happens to the record afterwards. */
export const TOP_QUESTIONS: QA[] = QUESTIONS.slice(0, 6);
