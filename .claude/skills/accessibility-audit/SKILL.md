...
description: Run a comprehensive accessibility audit on a web project using axe-core runtime browser scanning and eslint-plugin-jsx-a11y static analysis. Use when the user asks to run an accessibility scan, a11y audit, check accessibility, or verify WCAG compliance.
---
