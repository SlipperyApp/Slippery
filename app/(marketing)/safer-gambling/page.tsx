  ...
  return (
    <section className="sect">
      <div className="wrap">
        ...
        {/*  WHERE TO GET HELP, in place of a control this product no longer
             has. "Take a break" paused notifications and the leagues, which
             is a preference rather than a safeguard, and the owner removed
             it. What sits here instead is the thing somebody actually needs
             at this point on this page, and it is not ours: it is the
             national helpline, free and open at any hour. */}
        <div style={{ marginTop: 'var(--s5)' }}>
          <EndCard
            title="If betting has stopped being a choice"
            actions={
              <a href="https://www.begambleaware.org" className="btn btn--ghost" rel="noreferrer noopener" target="_blank">
                BeGambleAware <Icon name="arrowRight" size={16} />
              </a>
            }
          >
            The National Gambling Helpline is 0808 8020 133, free, at any hour of any day.
            Notifications can be turned off individually in Settings, and your ledger, history
            and export are yours whatever you decide.
          </EndCard>
        </div>
      </div>
    </section>
